            ...
            <div className="main">
                ...
                <div className="point-table">
                    ...
                    <div className="semi-table">
                        ...
                        <div className='mx-2'>
                            <div style={{ color: 'whitesmoke' }} className="point">{Attempted.toFixed(2)}%</div>
                    ...
                    <div className="semi-table">
                        ...
                        <div className='mx-2'>
                            <div style={{ color: 'whitesmoke' }} className="point">{total_que}</div>
                            <div className="point-info">
                                Total Questions
                            </div>
                        </div>
                    ...
                    <div className="semi-table">
                        ...
                        <div className='mx-2'>
                            <div style={{ color: 'whitesmoke' }} className="point">{correct_que}</div>
                            <div className="point-info">
                                Correct
                            </div>
                        </div>
                    ...
                    <div className="semi-table">
                        ...
                        <div className='mx-2'>
                            <div style={{ color: 'whitesmoke' }} className="point">{wrong_que}</div>
                            <div className="point-info">
                                Wrong
                            </div>
                        </div>
