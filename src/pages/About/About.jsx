...
const testimonials = [
    {
        ...
        avatar: 'https://avatars.githubusercontent.com/u/114654354?s=400'
        ...
        <Flex
            ...
            <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
                ...
                <chakra.h1
                    ...
                    fontFamily={'Work Sans'}
                    fontWeight={'bold'}
                    color={useColorModeValue('violet300', 'violet50')}>
                    Quiz Web App
                </chakra.h1>
                <chakra.h2
                    margin={'auto'}
                    ...
                    Test Your Knowledge with all the Fun Quizzes On Our Exciting Website And Enjoy while learning it!!!!
                </chakra.h2>
            </Box>
            <SimpleGrid
                columns={{ base: 1, xl: 1 }}
            ...
            <Box>
                <Icon viewBox="0 0 40 35" mt={14} boxSize={10} color={'white.600'}>
                    <path
                        fill={'currentColor'}
